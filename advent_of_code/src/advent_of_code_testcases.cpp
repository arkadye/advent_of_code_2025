...
verification_test advent_testcase_internal::make_test(std::string name, TestFunc func, std::string result)
{
...
verification_test advent_testcase_internal::make_test(std::string name, TestFuncWithArg func, std::string result, std::string arg)
{
	return verification_test{std::move(name), func, std::move(arg), std::move(result)};
}

verification_test advent_testcase_internal::make_test(std::string name, TestFuncWithArg func, Dummy, std::string arg)
{
