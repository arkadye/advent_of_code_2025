...
namespace utils
{
	...
	public:
		...
		explicit operator bool() const { return static_cast<bool>(get_value()); }
...
template <std::integral IntType, utils::modular_undwind_policy Policy>
...
template <typename IntTypeA, utils::modular_undwind_policy PolicyA, std::integral IntTypeB>
...
/*
template <std::integral IntTypeA, utils::modular_undwind_policy PolicyB, typename IntTypeB>
